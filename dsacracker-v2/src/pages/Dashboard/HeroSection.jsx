    ...
    return (
        ...
        >
            ...
            >
                ...
                <br />
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-accent-color to-blue-500">
                    Like Never Before.
                </span>
            </motion.h1>
            <motion.p variants={itemVars} className="text-lg md:text-xl text-text-secondary-light max-w-2xl mx-auto">
